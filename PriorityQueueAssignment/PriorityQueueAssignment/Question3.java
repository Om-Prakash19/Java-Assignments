/*
 * Question :  You are playing a solitaire game with three piles of stones of sizes a, b, and c respectively. Each turn you
...
public class Question3 {
    public static int maxScore(int a, int b, int c){
        ...
        int remaining = sum - maxVal;

        if(maxVal > remaining){
            return remaining;
        }else{
            return maxVal + (remaining - maxVal) / 2;
        }
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("The maximum score you can get is : " + maxScore(a, b, c));
    }
}
